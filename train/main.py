...
parser = argparse.ArgumentParser(description='PyTorch Training for Multi-label Image Classification(M-GCN)')

''' Fixed in general '''
parser.add_argument('--data_root_dir', default='E:\VOC2007/', type=str, help='save path')
parser.add_argument('--image-size', '-i', default=448, type=int)
parser.add_argument('--epochs', default=30, type=int)

parser.add_argument('--y', default=0.5, type=float)

parser.add_argument('--epoch_step', default=[15, 25], type=int, nargs='+', help='number of epochs to change learning rate')
# parser.add_argument('--device_ids', default=[0], type=int, nargs='+', help='number of epochs to change learning rate')
parser.add_argument('-b', '--batch-size', default=18, type=int) # RTX3080
parser.add_argument('-j', '--num_workers', default=16, type=int, metavar='INT', help='number of data loading workers (default: 4)')
...
parser.add_argument('--max_clip_grad_norm', default=20.0, type=float, metavar='M', help='max_clip_grad_norm')
parser.add_argument('--seed', default=1, type=int, help='seed for initializing training. ')

''' Train setting '''
parser.add_argument('--data', metavar='VOC2007', help='dataset name (e.g. COCO2014')
